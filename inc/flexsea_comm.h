...
/*
//extern uint8_t comm_str_1[COMM_PERIPH_ARR_LEN];		//LEAN_STACK
extern uint8_t rx_command_1[COMM_PERIPH_ARR_LEN];
//extern uint8_t comm_str_2[COMM_PERIPH_ARR_LEN];		//LEAN_STACK
extern uint8_t rx_command_2[COMM_PERIPH_ARR_LEN];
//extern uint8_t comm_str_3[COMM_PERIPH_ARR_LEN];		//LEAN_STACK
extern uint8_t rx_command_3[COMM_PERIPH_ARR_LEN];
//extern uint8_t comm_str_4[COMM_PERIPH_ARR_LEN];		//LEAN_STACK
extern uint8_t rx_command_4[COMM_PERIPH_ARR_LEN];
//extern uint8_t comm_str_5[COMM_PERIPH_ARR_LEN];		//LEAN_STACK
extern uint8_t rx_command_5[COMM_PERIPH_ARR_LEN];
//extern uint8_t comm_str_6[COMM_PERIPH_ARR_LEN];		//LEAN_STACK
